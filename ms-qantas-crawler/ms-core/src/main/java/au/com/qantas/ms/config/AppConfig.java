package au.com.qantas.ms.config;
...
@ComponentScan(basePackages = {
    // caching classes
    "au.com.qantas.ms.integration.cache",
    // controller
    "au.com.qantas.ms.controller",
    // service
    "au.com.qantas.ms.service",
    // validator
    "au.com.qantas.ms.validator",
    // config
    "au.com.qantas.ms.config"})
public class AppConfig {
    ...
    public ReloadableResourceBundleMessageSource messageSource() {
        ...
        messageBundle.setBasenames(
            "file:" + System.getProperty("user.home") + "/ms-core/messages",
